...
<head>
	...
	<link rel="icon" type="image/gif" href="/project/images/animated_favicon1.gif">
</head>
...
<?php
	if(!isset($_COOKIE["acknowledgement"])){
		...
		echo("<p>By using our website, you agree to our <a href='/project/cookie_policy.html' style='color: red'>cookie policy</a>.</p>");
...
?>
  <main>
	...
	<aside>
    <ul>
    	<li style="background-color: black; border-color: #228B22; border-width: 4px; width: 178px"><input type="submit" value="Want to edit this article?" class="button" id="submit_button" name="submit"></li>
    </ul>
	</aside>
	</form>
	<h1></h1>
